...
export default async function Home({
  ...
  return (
    <ResizablePanes
      ...
      >
        <header className="sticky top-[env(safe-area-inset-top)] z-30 bg-background/95 px-4 pt-3 backdrop-blur lg:static lg:bg-transparent lg:px-6 lg:pb-3 lg:pt-8 lg:backdrop-blur-none">
