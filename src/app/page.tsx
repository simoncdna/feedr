...
export default async function Home({
  ...
  return (
    <ResizablePanes
      ...
      >
        <header className="sticky top-0 z-30 bg-background/95 px-4 pt-[calc(env(safe-area-inset-top)+0.75rem)] backdrop-blur lg:static lg:bg-transparent lg:px-6 lg:pb-3 lg:pt-8 lg:backdrop-blur-none">
